...
if (isset($_POST['padd'])) {
    ...
    $query1 = "INSERT INTO f_invoice(f_name,f_date,f_price,f_quantity,f_folio_number,f_description,f_supplier_name,f_supplier_tt,f_srn,page_number,location,warranty) values ('$name','$date','$price','$quantity','$folio','$description','$sName','$s_tp','$srn','$pageNumber','$location','$warranty') ";
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE f_invoice SET f_name='$name',f_date='$date',f_price='$price',f_quantity='$quantity',f_folio_number='$folio',f_description='$description',f_supplier_name='$sName',f_supplier_tt='$s_tp',f_srn='$srn',page_number='$pageNumber',location='$location',warranty='$warranty' where invoice_id='$id'";
...
if (isset($_POST['setupdate'])) {
    ...
    $result = mysqli_query($con, $query);
    if ($result) {
        header("location: furnitureItems.php?search=true&id=$id");
    } else {
