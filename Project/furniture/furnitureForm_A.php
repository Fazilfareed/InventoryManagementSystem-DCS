...
if (isset($_GET['search'])) {
    ...
    if (!(empty($purchase_year)) and  !(empty($description))) {
        ...
        $queryinvoice = "SELECT * FROM f_forma_table WHERE purchase_year <= $purchase_year AND description='$description' ORDER BY description ASC";
    } elseif (!(empty($purchase_year))) {
        $queryinvoice = "SELECT * FROM f_forma_table WHERE purchase_year <= $purchase_year ORDER BY description ASC";
    } elseif (!(empty($description))) {
        $queryinvoice = "SELECT * FROM f_forma_table WHERE description='$description' ORDER BY description ASC";
    } else {
        $queryinvoice = "SELECT * FROM f_forma_table ORDER BY description ASC";
    }
