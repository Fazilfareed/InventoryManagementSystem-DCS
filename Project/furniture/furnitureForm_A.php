...
if (isset($_GET['export'])) {
    ...
    if (isset($_GET['year']) && !empty($_GET['year'])) {
        ...
        $queryinvoice = "SELECT * FROM f_forma_table where purchase_year <= $purchase_year ";
    } else {
        $queryinvoice = "SELECT * FROM f_forma_table";
    }
...
if (isset($_GET['search'])) {
    ...
    if (!(empty($purchase_year)) and  !(empty($description))) {
        ...
        $queryinvoice = "SELECT * FROM f_forma_table WHERE purchase_year <= $purchase_year AND description='$description' ";
    } elseif (!(empty($purchase_year))) {
        $queryinvoice = "SELECT * FROM f_forma_table WHERE purchase_year <= $purchase_year ";
    } elseif (!(empty($description))) {
        $queryinvoice = "SELECT * FROM f_forma_table WHERE description='$description' ";
    } else {
        $queryinvoice = "SELECT * FROM f_forma_table ";
    }
        ...
        <div class="container">
            ...
            <div>
                <form action="furnitureForm_A.php" method="get">
                    ...
                    <a href="furnitureForm_A.php?export=true&year=<?php
                                                                    if (isset($_GET['year'])) {
