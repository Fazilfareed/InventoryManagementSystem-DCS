...
if (isset($_GET['exportXL'])) {
    ...
    header('Content-Disposition: attachment;filename="furniture_form_B.csv"');
    ...
    if (isset($_GET['sdrt']) && !empty($_GET['sdrt'])) {
        ...
        $queryinvoice = "SELECT * FROM f_formb_table WHERE sdrt='$sdrt'";
    } else {
    ...
    <div class="main-container">
        <div class="container">
            ...
            <div>
                ...
                <form action="furnitureForm_B.php" method="get">
                    ...
                    <?php if (isset($_GET['sdrt'])) { ?>
                        <a href="furnitureForm_B.php?exportXL=true&sdrt=<?php echo urlencode($_GET['sdrt']); ?>"><input class="button" value="Export to Excel" /></a>
                        <a href="furnitureForm_B.php?export=true&sdrt=<?php echo urlencode($_GET['sdrt']); ?>"><input class="button" value="Export to PDF" /></a>
