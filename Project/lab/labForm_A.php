...
$queryinvoice = "SELECT * FROM forma_table ORDER BY description ASC LIMIT $offset, $rowsPerPage";

$totalRows = mysqli_num_rows(mysqli_query($con, "SELECT * FROM forma_table"));
...
if (isset($_GET['search'])) {
    ...
    if (!(empty($purchase_year)) and  !(empty($description))) {
        ...
        $queryinvoice = "SELECT * FROM forma_table WHERE purchase_year <= $purchase_year AND description='$description' ORDER BY description ASC";
    } elseif (!(empty($purchase_year))) {
        $queryinvoice = "SELECT * FROM forma_table WHERE purchase_year <= $purchase_year ORDER BY description ASC";
    } elseif (!(empty($description))) {
        $queryinvoice = "SELECT * FROM forma_table WHERE description='$description' ORDER BY description ASC";
    } else {
        $queryinvoice = "SELECT * FROM forma_table ORDER BY description ASC";
    }
