...
if (isset($_GET['exportXL'])) {
    ...
    header('Content-Disposition: attachment;filename="lab_form_B.csv"');
            ...
            <div>
                ...
                <form action="labForm_B.php" method="get">
                    ...
                    <?php if (isset($_GET['sdrt'])) { ?>
                        <a href="labForm_B.php?exportXL=true&sdrt=<?php echo urlencode($_GET['sdrt']); ?>"><input class="button" value="Export to Excel" /></a>
                        <a href="labForm_B.php?export=true&sdrt=<?php echo urlencode($_GET['sdrt']); ?>"><input class="button" value="Export to PDF" /></a>
