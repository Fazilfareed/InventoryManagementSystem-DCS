    ...
    if(isset($_POST["update"])){
        ...
        if($password == $c_password ){
            ...
            if(mysqli_num_rows($result) > 1){
                ...
                echo "<script>alert('UserName or email alredy taken');window.location.href='../admin/index.php';</script>";
            }
            else{
            ...
            // echo "<script>alert('Re Enter Password')</script>";
            // header("location: ../admin/index.php");
            echo "<script>alert('Re Enter Passwor');window.location.href='../admin/index.php';</script>";
        }
